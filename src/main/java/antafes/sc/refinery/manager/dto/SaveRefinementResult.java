...
public record SaveRefinementResult(boolean successful, RefinementValidation validation)
{
    public static SaveRefinementResult success()
    {
        return new SaveRefinementResult(true, RefinementValidation.valid());
    }

    public static SaveRefinementResult failure(RefinementValidation validation)
    {
        return new SaveRefinementResult(false, validation);
    }
}
