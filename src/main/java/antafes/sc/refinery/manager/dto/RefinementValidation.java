...
public record RefinementValidation(String costErrorKey, List<MaterialRowValidation> materialRows,
                                   InvalidField firstInvalidField)
{
    public static RefinementValidation valid()
    {
        return new RefinementValidation(null, List.of(), null);
    }

    public boolean isValid()
    {
        return this.costErrorKey == null && this.materialRows.stream()
            .noneMatch(MaterialRowValidation::hasErrors) && this.firstInvalidField == null;
    }
}
