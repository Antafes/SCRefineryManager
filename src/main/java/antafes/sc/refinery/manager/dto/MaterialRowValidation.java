...
public record MaterialRowValidation(String materialErrorKey, String amountErrorKey, String revenueErrorKey)
{
    public boolean hasErrors()
    {
        return this.materialErrorKey != null || this.amountErrorKey != null || this.revenueErrorKey != null;
    }
}
