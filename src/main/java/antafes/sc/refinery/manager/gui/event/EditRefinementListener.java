...
public class EditRefinementListener extends EventListener<EditRefinementEvent>
{
    public EditRefinementListener()
    {
    }

    public EditRefinementListener(Consumer<EditRefinementEvent> consumer)
    {
        super(consumer);
    }

    public EditRefinementListener(Consumer<EditRefinementEvent> consumer, int priority)
    {
