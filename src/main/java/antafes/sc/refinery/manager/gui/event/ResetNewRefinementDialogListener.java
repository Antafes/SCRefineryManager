...
public class ResetNewRefinementDialogListener extends EventListener<ResetNewRefinementDialogEvent>
{
    public ResetNewRefinementDialogListener()
    {
    }

    public ResetNewRefinementDialogListener(Consumer<ResetNewRefinementDialogEvent> consumer)
    {
        super(consumer);
    }

    public ResetNewRefinementDialogListener(Consumer<ResetNewRefinementDialogEvent> consumer, int priority)
    {
