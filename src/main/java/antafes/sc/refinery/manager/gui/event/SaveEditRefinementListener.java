...
public class SaveEditRefinementListener extends EventListener<SaveEditRefinementEvent>
{
    public SaveEditRefinementListener()
    {
    }

    public SaveEditRefinementListener(Consumer<SaveEditRefinementEvent> consumer)
    {
        super(consumer);
    }

    public SaveEditRefinementListener(Consumer<SaveEditRefinementEvent> consumer, int priority)
    {
