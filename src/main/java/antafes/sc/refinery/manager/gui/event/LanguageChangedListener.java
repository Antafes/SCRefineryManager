...
public class LanguageChangedListener extends EventListener<LanguageChangedEvent>
{
    public LanguageChangedListener()
    {
    }

    public LanguageChangedListener(Consumer<LanguageChangedEvent> consumer)
    {
        super(consumer);
    }

    public LanguageChangedListener(Consumer<LanguageChangedEvent> consumer, int priority)
    {
